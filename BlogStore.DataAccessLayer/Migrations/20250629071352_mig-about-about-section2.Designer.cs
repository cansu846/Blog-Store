...
namespace BlogStore.DataAccessLayer.Migrations
{
    ...
    [Migration("20250629071352_mig-about-about-section2")]
    partial class migaboutaboutsection2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogStore.EnitityLayer.Entities.Category", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlogStore.EnitityLayer.Entities.Comment", b =>
                {
            ...
            modelBuilder.Entity("BlogStore.EnitityLayer.Entities.Tag", b =>
                {
            ...
            modelBuilder.Entity("BlogStore.EnitityLayer.Entities.Article", b =>
                {
                    ...
                    b.HasOne("BlogStore.EnitityLayer.Entities.Category", "Category")
                        .WithMany("Articles")
            ...
            modelBuilder.Entity("BlogStore.EnitityLayer.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("BlogStore.EnitityLayer.Entities.Article", "Article")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BlogStore.EnitityLayer.Entities.AppUser", null)
                        .WithMany()
